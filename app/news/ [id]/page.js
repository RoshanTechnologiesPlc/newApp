...
export default function NewsDetailPage() {
  ...
  useEffect(() => {
    ...
    // First try the direct endpoint, fall back to filtering the full list
        ...
        <article>
          ...
          <div className="px-4 pt-5 pb-8">
            ...
            <a
              ...
              className="mt-8 flex items-center justify-center gap-2 w-full
                         bg-green-700 hover:bg-green-800 active:bg-green-900
                         text-white font-semibold text-sm py-4 rounded-2xl
                         transition-colors shadow-lg shadow-green-700/25"
            >
